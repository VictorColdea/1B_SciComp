...
class Planet():
    ...
    def __init__(self, SolarSys, mass, position=(0, 0, 0), velocity=(0, 0, 0)): # starts off at origin at rest
...
planet1 = Planet(SolarSys, mass=10, position=(150, 50, 0), velocity=(-5, 5, 0))
