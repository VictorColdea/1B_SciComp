...
class SolarSystem():
    ...
    def fix_axes(self):
        ...
        for planet in range(len(self.planets)-1):
            self.ax.text(self.planets[planet].position[0]+10,self.planets[planet].position[1]+10,f"Planet {planet+1}")
        #self.ax.text(self.planets[-1].position[0]+10,self.planets[-1].position[1]+10,"Sun")
        self.ax.text(10,10,"Sun")
...
planet1 = Planet(SolarSys, mass=10, position=(100, 0), velocity=(0, 10))
planet2 = Planet(SolarSys, mass=10, position=(-200, 0), velocity=(0, -8))
